...
while True:
    ...
    a1_1=int(value_8.get())
    a1_1=int(value_9.get())

    a1_2=int(value_10.get())
    a1_2=int(value_11.get())
    a1_2=int(value_12.get())
    label1_1 = ttk.Label(text='h_min', foreground="#00FF00")
    label2_1 = ttk.Label(text='s_min', foreground="#00FF00")
    label3_1 = ttk.Label(text='v_min', foreground="#00FF00")
    label4_1 = ttk.Label(text='h_max', foreground="#00FF00")
    label5_1 = ttk.Label(text='s_max', foreground="#00FF00")
    label6_1 = ttk.Label(text='v_max', foreground="#00FF00")

    label7_1 = ttk.Label(text='h_min_master', foreground="#CC0033")
    label8_1 = ttk.Label(text='s_min_master', foreground="#CC0033")
    label9_1 = ttk.Label(text='v_min_master', foreground="#CC0033")
    label10_1 = ttk.Label(text='h_max_master', foreground="#CC0033")
    label11_1 = ttk.Label(text='s_max_master', foreground="#CC0033")
    label12_1 = ttk.Label(text='v_max_master', foreground="#CC0033")

    label13_1 = ttk.Label(text='h_min_slave', foreground="#CC0033")
    label14_1 = ttk.Label(text='s_min_slave', foreground="#CC0033")
    label15_1 = ttk.Label(text='v_min_slave', foreground="#CC0033")
    label16_1 = ttk.Label(text='h_max_slave', foreground="#CC0033")
    label17_1 = ttk.Label(text='s_max_slave', foreground="#CC0033")
    label18_1 = ttk.Label(text='v_max_slave', foreground="#CC0033")
